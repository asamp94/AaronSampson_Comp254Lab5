...
/**
 * An abstract base class providing some functionality of the QuestionOne.Tree interface.
 *
...
public abstract class AbstractTree<E> implements Tree<E> {
  ...
  /**
   * Returns true if QuestionOne.Position p has one or more children.
   *
  ...
  /**
   * Returns true if QuestionOne.Position p does not have any children.
   *
   * @param p    A valid QuestionOne.Position within the tree
  ...
  /**
   * Returns true if QuestionOne.Position p represents the root of the tree.
   *
   * @param p    A valid QuestionOne.Position within the tree
  ...
  /**
   * Returns the number of children of QuestionOne.Position p.
   *
   * @param p    A valid QuestionOne.Position within the tree
   * @return number of children of QuestionOne.Position p
   * @throws IllegalArgumentException if p is not a valid QuestionOne.Position for this tree.
   */
  @Override
  ...
  /** Returns the number of levels separating QuestionOne.Position p from the root.
   *
   * @param p A valid QuestionOne.Position within the tree
   * @throws IllegalArgumentException if p is not a valid QuestionOne.Position for this tree.
   */
  ...
  /**
   * Returns the height of the subtree rooted at QuestionOne.Position p.
   *
   * @param p A valid QuestionOne.Position within the tree
   * @throws IllegalArgumentException if p is not a valid QuestionOne.Position for this tree.
   */
  ...
  /**
   * Adds positions of the subtree rooted at QuestionOne.Position p to the given
   * snapshot using a preorder traversal
   * @param p       QuestionOne.Position serving as the root of a subtree
